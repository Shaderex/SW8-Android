...
public class WifiSensorProviderTest extends ApplicationTestCase<DataCollectionApplication> {
  ...
  public void testGpsSensorProviderData() throws Exception {
    ...
    final Sample sample1 = wifiSensorProvider.retrieveSampleForDuration(sampleDuration, measurementFrequency);

    final Sample sample2 = wifiSensorProvider.retrieveSampleForDuration(sampleDuration, measurementFrequency);
    ...
    for (final Object measurement : sample1.getMeasurements()) {
      ...
      for (Object o : aids) {
        assertTrue("Item in sample1 is not of type ScanResult", o instanceof ScanResult);
      }
    }
    ...
    for (final Object measurement : sample2.getMeasurements()) {
      ...
      for (Object o : aids) {
        assertTrue("Item in sample2 is not of type ScanResult", o instanceof ScanResult);
      }
    }
